...
<li class="s-bd2 s-bg2">
	<div class="bcmtlsta clearfix" id="comment-<?php echo $comment['cid']; ?>">
		<a name="<?php echo $comment['cid']; ?>"></a>
		<?php if($isGravatar == 'y'): ?><div class="bcmtlstb"><img class="itag" src="<?php echo getGravatar($comment['mail']); ?>" /></div><?php endif; ?>
		<div class="bcmtlstc">
                        <div class="bcmtlstd clearfix">
                            <div class="bcmtlste clearfix">
                                <div class="bcmtlstg">
                                    <div class="bcmtlsti">
			                                        <div class="bcmtlstj">													<?php if($comment['level'] < 4): ?><div class="comment-reply"><a href="#comment-<?php echo $comment['cid']; ?>" onclick="commentReply(<?php echo $comment['cid']; ?>,this)">@<?php echo $comment['poster']; ?></a></div>
														<?php endif; ?><?php if($comment['level'] >= 4): ?><?php echo $comment['poster']; ?><?php endif; ?><span class="s-fc3 itag" style="display:none;">回复了&nbsp;&nbsp;<a target="_top" class="s-fc2 itag"></a></span><span class="bcmtlstf s-fc4">：</span><span class="bcmtlstf s-fc4 itag"><?php echo $comment['content']; ?></span></div>
...
function blog_comments_post($logid,$ckname,$ckmail,$ckurl,$verifyCode,$allow_remark){
	...
	<div class="comment-post" id="comment-post">
		...
		<form method="post" name="commentform" action="<?php echo BLOG_URL; ?>index.php?action=addcom" id="commentform">
			...
			<?php endif; ?>
			<p><textarea name="comment" id="comment" rows="4" tabindex="4"></textarea></p>
