...
function widget_search($title){ ?>
	<h3><?php echo $title; ?></h3>
        <form name="keyform" method="get" action="<?php echo BLOG_URL; ?>index.php">
          <p>
          	<input class="search" name="keyword" class="search" type="text" />
            <input name="search" type="image" style="border: 0; margin: 0 0 -9px 5px;" src="<?php echo TEMPLATE_URL; ?>images/search.png" alt="Search" title="Search" />
          </p>
        </form>
...
function blog_navi(){
	...
	foreach($navi_cache as $value):
        ...
        $current_tab = BLOG_URL . trim(Dispatcher::setPath(), '/') == $value['url'] ? 'selected' : '';
		?>
...
function blog_comments_post($logid,$ckname,$ckmail,$ckurl,$verifyCode,$allow_remark){
	...
	<div class="form_settings" id="comment-post">
		...
		<form method="post" name="commentform" action="<?php echo BLOG_URL; ?>index.php?action=addcom" id="commentform">
			...
			<p>
				<input class="contact" type="text" name="comname" maxlength="49" value="<?php echo $ckname; ?>" size="22" tabindex="1">
				<label for="author"><small>昵称</small></label>
			</p>
			<p>
				<input class="contact" type="text" name="commail"  maxlength="128"  value="<?php echo $ckmail; ?>" size="22" tabindex="2">
				<label for="email"><small>邮件地址 (选填)</small></label>
			</p>
			<p>
				<input class="contact" type="text" name="comurl" maxlength="128"  value="<?php echo $ckurl; ?>" size="22" tabindex="3">
				<label for="url"><small>个人主页 (选填)</small></label>
			</p>
			<?php endif; ?>
			<p><textarea name="comment" class="contact textarea" id="comment" rows="10" tabindex="4"></textarea></p>
			<p><?php echo $verifyCode; ?> <input class="submit" type="submit" id="comment_submit" value="发表评论" tabindex="6" /></p>
