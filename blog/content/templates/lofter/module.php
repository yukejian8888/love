...
function neighbor_log($neighborLog){
	extract($neighborLog);?>
    <?php if($prevLog): ?>
	<div class="prev active"><a href="<?php echo Url::log($prevLog['gid']) ?>" style="cursor: pointer; width: 20px; overflow: hidden;"><span class="cap"></span><span class="arrow"></span><span class="title" style="display: none;">上一篇</span></a></div>
    <?php else: ?>
    <div class="prev disable"><span class="cap"></span><span class="arrow"></span></div>
    <?php endif; ?>
    <?php if($nextLog): ?>
	<div class="next active"><a href="<?php echo Url::log($nextLog['gid']) ?>" style="cursor: pointer; width: 20px;"><span class="cap"></span><span class="arrow"></span><span class="title" style="display: none;">下一篇</span></a></div>
    <?php else: ?>
    <div class="next disable"><span class="cap"></span><span class="arrow"></span></div>
    <?php endif; ?>
<?php }?>
<?php
//blog：引用通告
